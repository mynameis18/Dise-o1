const API_KEYS = {
    cuenta1: 'AIzaSyDJBknZw0h3kgqW82Mjm4spv888CF5uzXk',
    cuenta2: 'AIzaSyCbcbGeaL0sd0TGvlnSe1RBWhKaIorAAYw',
    cuenta3: 'AIzaSyAoHdWV_aEadb6z_xZetc0loKuOmsl2qLU',
...
function initYouTubeAPI() {
    gapi.client.init({
        ...
        // La API de YouTube está lista para usar.
        // Puedes comenzar a buscar y reproducir videos aquí.
    });
}
...
// Cuando se envía el formulario, busca y reproduce el video correspondiente a la frase.
...
function buscarURLDeVideo(frase) {
  ...
  return null; // Retorna null si no se encuentra una correspondencia
}
